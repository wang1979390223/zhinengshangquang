<template>
  <div class="water-eval-container">
    <div id="barone" class="cityGreenLand-charts"></div>
    <div class="dizuo">
      <img src="@/assets/images/fw/rightTopDIZuo.png" alt="">
    </div>
    <!-- <div class="img"><img src="../assets/img/f1.png"></div> -->
  </div>
</template>
